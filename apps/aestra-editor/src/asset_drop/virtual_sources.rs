    ...
    if built_in {
        ...
        for material in &session.effect.materials {
            entries.push(Entry {
                ...
                kind: "Local material", description: "Material stored in this effect. Drop onto a compatible renderer or Material field.".into(),
            });
        }
        ...
        for flipbook in &session.effect.flipbooks {
            entries.push(Entry {
                ...
                description: "Atlas metadata stored in this effect. Drop onto a Flipbook renderer. Creating an atlas does not change the texture file.".into(),
            });
        }
    }
