...
struct PanelSources<'a> {
    ...
    function_graph_menus: &'a crate::material_function_editor::graph::FunctionGraphMenuState,
    material_graph_selection: &'a MaterialGraphSelectionState,
    material_graph_previews: &'a MaterialGraphPreviewState,
...
pub(crate) struct DockUiResources<'w> {
    ...
    function_graph_menus: Res<'w, crate::material_function_editor::graph::FunctionGraphMenuState>,
    material_graph_selection: Res<'w, MaterialGraphSelectionState>,
    material_graph_previews: Res<'w, MaterialGraphPreviewState>,
...
impl<'w> DockUiResources<'w> {
    fn panel_sources<'a>(&'a self, session: &'a EditorSession) -> PanelSources<'a> {
        PanelSources {
            ...
            function_graph_menus: &self.function_graph_menus,
            material_graph_selection: &self.material_graph_selection,
            material_graph_previews: &self.material_graph_previews,
