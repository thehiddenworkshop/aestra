...
const EDITOR_MESSAGE_IDS: &[&str] = &[
    ...
    "browser-mesh-thumbnail-ready",
    "browser-effect-thumbnail-ready",
    ...
    "browser-deleted-description",
    "browser-delete-status",
    "browser-restore-status",
    "browser-delete-checking",
    "browser-delete-active",
    "browser-delete-restore",
    "browser-deleted-empty",
    "browser-recovery-description",
    "browser-recovery-summary",
    "browser-recovery-later",
    "browser-recovery-retry",
    "browser-recovery-restore",
    "browser-recovery-drafts",
    "browser-recovery-changed",
    "browser-recovery-restored",
    ...
    "persistence-recovery-material",
    "persistence-recovery-details",
    "persistence-recovery-age-now",
    ...
    "compiler-wesl-title",
    "compiler-wesl-status-ok",
    "compiler-wesl-status-error",
    "compiler-wesl-status-pending",
    "compiler-wesl-error",
    "compiler-wesl-pending",
    ...
    "profiler-metric-trail-capacity",
