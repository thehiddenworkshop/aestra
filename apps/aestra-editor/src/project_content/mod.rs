...
/// The project the editor opens by default: the curated sample project at the repo root. Editor UI
/// assets live under `assets/`; workspace test fixtures live under `assets/test/`.
