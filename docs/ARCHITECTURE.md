...
- Owns a dedicated `src/feathers/` widget layer above Bevy Feathers. Reusable
  ...
  panel chrome, delayed window-aware tooltips, BSN scenes, scroll areas, separators,
  and status surfaces live there rather than in application or panel builders.
