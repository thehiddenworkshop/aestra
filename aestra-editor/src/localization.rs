...
const EDITOR_MESSAGE_IDS: &[&str] = &[
    ...
    "properties-input-size-over-life",
    "properties-input-size-over-life-description",
    "properties-input-opacity-over-life",
    "properties-input-opacity-over-life-description",
    "properties-input-color-over-life",
    "properties-input-color-over-life-description",
    "properties-effect",
