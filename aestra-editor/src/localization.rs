...
const EDITOR_MESSAGE_IDS: &[&str] = &[
    ...
    "inspector-effect",
    "inspector-effect-name",
    "inspector-effect-name-description",
    "inspector-effect-name-status-target",
    "inspector-effect-looping",
    "inspector-effect-looping-description",
    "inspector-emitter",
    "inspector-emitter-name",
    "inspector-emitter-name-description",
    "inspector-emitter-name-status-target",
    "inspector-emitter-enabled",
    "inspector-emitter-enabled-description",
    "inspector-emitter-capacity",
    "inspector-emitter-capacity-description",
    "inspector-events",
    "inspector-events-empty",
    "inspector-events-add",
    "inspector-events-add-description",
    "inspector-events-no-targets",
    "inspector-event-link",
    "inspector-event-on-spawn",
    "inspector-event-on-death",
    "inspector-event-on-collision",
    "inspector-status-selected-compiled",
    "inspector-status-selected",
    "inspector-status-module-registry-unavailable",
    "inspector-status-module-missing",
    "inspector-status-input-metadata-unavailable",
    "inspector-status-not-choice",
    "inspector-status-choice-unavailable",
    "inspector-status-target-unavailable",
    "inspector-status-finite-number-required",
    "inspector-status-incompatible-metadata",
    "inspector-status-updated",
    "inspector-status-name-required",
    "inspector-status-event-added",
    "inspector-status-event-removed",
    "inspector-status-event-duplicate",
    "inspector-status-event-self-target",
    "inspector-status-event-target-missing",
