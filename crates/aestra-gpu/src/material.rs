...
use aestra_compiler::{
    MaterialIrConstant, MaterialIrInstruction, MaterialIrProgram, MaterialIrSourceMap,
    MaterialIrValue, MaterialIrValueId,
};
use aestra_core::{
    MaterialExpressionId, MaterialParameterId,
    material::{
